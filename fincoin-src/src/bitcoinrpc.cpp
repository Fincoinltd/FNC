...
{
    return GetBoolArg("-testnet", false) ? 18345 : 20091;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop FinCoin server (and possibly override the detachdb config value).");
