...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\FinCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\FinCoin
    // Mac: ~/Library/Application Support/FinCoin
    // Unix: ~/.FinCoin
#ifdef WIN32
    // Windows
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                if (!fMatch)
                {
                    ...
                    printf("*** %s\n", strMessage.c_str());
                    uiInterface.ThreadSafeMessageBox(strMessage+" ", string("FinCoin"), CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION);
                }
            }
        }
        if (fDebug) {
