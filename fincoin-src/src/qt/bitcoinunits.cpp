...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("FinCoins"));
    case mBTC: return QString(QObject::tr("Milli-FinCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-FinCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
